...
//----------------------------------------------------Wishlist routes--------------------------------------------------------------------------
userRoutes.get('/wishlistPage', Userauth, wishlistController.getWishlist);
userRoutes.post('/add-to-wishlist/:id', Userauth, wishlistController.addToWishlist);
userRoutes.delete('/remove-from-wishlist/:id', Userauth, wishlistController.removeFromWishlist);
userRoutes.post('/move-to-cart/:id', Userauth, wishlistController.moveToCart);
// -------------------------------------------------------filters------------------------------------------------------------------------------
